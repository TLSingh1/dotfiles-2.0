...
import wlsunset from "service/wlsunset"
//import wlsunsetService from './wlsunsetService.js';
...
// export const WlsunsetIndicator = () => Widget.Label({
//   label: wlsunset.bind('active').as(active => active ? 'N' : 'D'),
//   setup: self => self.hook(wlsunset, () => {
//     self.label = wlsunset.active ? 'N' : 'D';
//   }),
// });
